...
#define ioctl_read_memory CTL_CODE(FILE_DEVICE_UNKNOWN, 0x9867452, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define ioctl_write_memory CTL_CODE(FILE_DEVICE_UNKNOWN, 0x9867453, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define ioctl_get_module_base CTL_CODE(FILE_DEVICE_UNKNOWN, 0x9867454, METHOD_BUFFERED, FILE_SPECIAL_ACCESS) 
#define ioctl_protect_virutal_memory CTL_CODE(FILE_DEVICE_UNKNOWN, 0x9867455, METHOD_BUFFERED, FILE_SPECIAL_ACCESS) 
#define ioctl_allocate_virtual_memory CTL_CODE(FILE_DEVICE_UNKNOWN, 0x9867456, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
bool kernelmode_proc_handler::attach(const char* proc_name) {
	...
	handle = CreateFileA(XorStr("\\\\.\\K.F.B.B.S.U.F.B.U.S.H.Y.E.Y.S.B.B").c_str(), GENERIC_READ | GENERIC_WRITE,
